...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221102_astrojupiter_b7ff0b5b9bd47fe12034_20221103220426_archive.zip';
        const ARCHIVE_SIZE       = '51757675';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'b7ff0b5-03220426';
        const SECONDARY_PACKAGE_HASH = '11f3aa1-03220426';
        const VERSION            = '1.5.0';
