...
public class Porcentagem extends JDialog {
	...
	public Porcentagem() {
		...
		txtValor.setBounds(128, 54, 114, 20);
		...
		txtResultado.setBounds(332, 54, 114, 20);
		...
		txtLucro.setBounds(146, 126, 61, 19);
		getContentPane().add(txtLucro);
		txtLucro.setColumns(10);

		txtVenda = new JTextField();
		txtVenda.setEditable(false);
		txtVenda.setBounds(324, 126, 114, 19);
		...
		btnCalcular.setBounds(219, 120, 95, 25);
		...
		txtDesconto.setBounds(144, 210, 73, 19);
		...
		txtTotal.setBounds(336, 210, 114, 19);
